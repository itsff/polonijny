...
public class EntryAuditor : IEntryAuditor
{
    ...
    public EntryAuditor(IRepository repo)
    {
        _repo = repo;
    }
    ...
    static void SpotCheck(Entry entry, List<IAuditIssue> problems)
    {
    ...
    static void CheckPunctuation(Entry entry, List<IAuditIssue> problems)
    {
    ...
    void CheckLinks(Entry entry, List<IAuditIssue> problems)
    {
